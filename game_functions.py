...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets, mouse_x, mouse_y):
    ...
    if button_clicked and not stats.game_active:
        ...
        if play_button.rect.collidepoint(mouse_x, mouse_y):
            ...
            # Reiniciaas imagens do painel de pontuação
            sb.prep_score()
            sb.prep_high_score()
            sb.prep_level()
            sb.prep_ships()
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    ...
    :param ai_settings: settings do jogo
    :param screen: propiedades da tela principal
    :param ship: propriedades da nave
    :return:
    """
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # Apaga os projéteis que desaparecem da tela
...
def check_fleet_edges(ai_settings, aliens):
    """
    Responde apropriadamente se algum alienígena alcançoe uma borda
    :param ai_settings:
    :param aliens:
    :return:
    """
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # Verifica se houve colisõe entre alienígenas e a nave
...
def ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    :return:
    """
    # Responde ao fato da nave ter sido atingida por um alienígena
...
def check_high_score(stats, sb):
    """
    Verificase há uma nova pontuação máxima
    :param stats:
    :param sb:
    :return:
    """
